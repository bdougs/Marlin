 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 200, 15000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.30 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.5, 0, -3.7 }
